...
from socialmediaapi.tasks import (APIResponseError,
                                  send_simple_email,
...
@pytest.mark.anyio
async def test_generate_cute_creatures_api_sucess(mock_httpx_client):
    json_data = {"output": "https://example.com/image,jpg"}
